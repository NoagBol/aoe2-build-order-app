...
file_path = os.path.join(os.path.dirname(__file__), '5_📊_Statistics.py')

# Create a module spec
spec = importlib.util.spec_from_file_location('statistics_module', file_path)

# Create a module from the spec
module = importlib.util.module_from_spec(spec)

# Add the module to sys.modules
sys.modules['statistics_module'] = module
